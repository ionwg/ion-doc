...
architectural style and the success of the JavaScript programming language, HTTP-enabled applications are increasingly
supporting {uri-json}[JSON] as a preferred data format for data exchange.
