...
.Form Field Option
A Collection Object named `options` that is a member of a Form Field.
...
(colloquially referred to as https://en.wikipedia.org/wiki/HATEOAS[HATEOAS]).
